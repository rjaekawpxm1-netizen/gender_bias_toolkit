...
if menu == "📊 종합 대시보드":
    ...
    findings = [
        ("🔴", "가구형태 편향 최심각", "반사실적 시험 50% / WEAT d=-1.479 (p=0.036) — 통계적 유의"),
        ("🔴", "해바라기센터 API 데이터 공백", "2022년 등록 후 3년간 데이터 0건 — 관리 부실 확인"),
        ("🔴", "다문화가족 데이터 오류", "국적취득여부 38,469건(75.9%) 이상값 발견"),
        ("🟠", "성평등 도메인 DI 0.799", "Disparate Impact 0.8 기준 미달 — 편향 판정"),
        ("🟠", "3중 복합 편향 GPT 25%", "성별×연령×가구형태 조합에서 단일 편향보다 높은 탐지율"),
        ("🟡", "적대적 프롬프팅 4건 취약", "피해자 귀인 / 가구형태 차별 유형에서 AI 수용 확인"),
    ]
